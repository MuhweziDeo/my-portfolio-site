<template>
    <div class="stacks">
        <h1 class="header">My Languages & Frameworks</h1>
        <div class="stacks__languages">
            <div class="stacks__languages--heading">
                <h1>Languages</h1>
            </div>

            <div class="stacks__languages--content">
        ...
        <div class="stacks__frameworks">
            <div class="stacks__frameworks--heading">
                <h1>Frameworks</h1>
            </div>

            <div class="stacks__frameworks--content">
        ...
        <div class="stacks__databases">
            <div class="stacks__databases--heading">
                <h1>Databases</h1>
            </div>

            <div class="stacks__databases--content">
        ...
        <div class="stacks__testing">
            <div class="stacks__testing--heading">
                <h1>Testing</h1>
            </div>

            <div class="stacks__testing--content">
        ...
        <div class="stacks__tools">
            <div class="stacks__tools--heading">
                <h1>Tools</h1>
            </div>

            <div class="stacks__tools--content">
